...
export default function Home() {
  return (
    ...
    >
      ...
      <section className="py-20 bg-depurple-800 flex min-h-[100dvh]">
        <div className="mx-auto flex items-center justify-center gap-6 rounded-lg flex-wrap max-w-[90dvw]">
          <div className="flex flex-col gap-4 bg-white p-10 max-h-[454px] max-w-[470px] rounded-lg">
            ...
            <h1 className="sm:text-5xl text-4xl text-depurple-800 font-bold">
          ...
          <div className="relative sm:top-36 text-center container flex items-center justify-center py-8 xl:gap-24 gap-4 bg-white shadow-lg rounded-2xl flex-wrap px-4">
      ...
      <section className="py-20 sm:mt-24 mt-8">
        <div className="container">
          <h1 className="text-5xl font-bold text-depurple-800">Sobre nós</h1>
      ...
      <section className="py-16 bg-depurple-800">
        <div className="container flex flex-col items-center justify-center">
          ...
          <h1 className="sm:text-5xl text-3xl font-bold text-white uppercase">Top Morango</h1>
